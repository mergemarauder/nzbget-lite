...
if(NOT EXISTS ${CMAKE_BINARY_DIR}/${CONF_FILE})
file(READ ${CONF_FILE_SRC} CONFIG_CONTENT)
	string(REPLACE "ConfigTemplate=" "ConfigTemplate=${TEMPLATE_CONF_FILE_DEST}/${CONF_FILE}" MODIFIED_CONFIG_CONTENT "${CONFIG_CONTENT}")
